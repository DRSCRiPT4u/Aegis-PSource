...
public class MapleCharacter extends AbstractMapleCharacterObject {
    ...
    private static final String[] BLOCKED_NAMES = {"admin", "owner", "moderator", "intern", "donor", "administrator", "FREDRICK", "help", "helper", "alert", "notice", "MapleAegis", "fuck", "wizet", "fucking", "negro", "fuk", "fuc", "penis", "pussy", "asshole", "gay",
    ...
    private int deafultExp;
    private int gmLevel;
    private int whenFishMax;

    //Weekly Challenge//
    public int TotalMobKilledW;
    public int MesoW; // V
    public int NXW; // V
    public int ScrollFailW; // V
    public int FameW; // V
    public int FameGivenW; // V
    public int QuestCW;
    public int MiniW;
    public int JQW;
    public int NGachW;
    public int RGachW;
    public int OpenMerchW;
    public int SellItemW;
    public int BoughtItemW;
    public int ZakumKillW;
    //Monthly Challenge//
    public int TotalMobKilledM;
    public int MesoM; // V
    public int BoughtItemM;
    public int NXM; // V
    public int ScrollFailM;
    public int FameM; // V
    public int FameGivenM; // V
    public int QuestCM;
    public int MiniM;
    public int JQM;
    public int NGachM;
    public int RGachM;
    public int OpenMerchM;
    public int SellItemM;
    public int ZakumKillM;
    public int VoteM;
    //Progress Saver//
    public int WCP;
    public int MCP;
    public int TotalChallengeP;
    //Reward check//
    public int FirstRewardW;
    public int FirstRewardM;
    public int SecondRewardW;
    public int SecondRewardM;
    public int ThirdRewardW;
    public int ThirdRewardM;
    public int FourthRewardW;
    public int FourthRewardM;
    public int FifthRewardW;
    public int FifthRewardM;
    //Regression
    public int charinacc = 0;
    //Quests
    public int QuestsCompleted;
    //Logs
    public int ZakumKillT;
    //Tiers



    private int AegisPoints;
    //private int votePoints;
    private int ci = 0;
    private MapleFamilyEntry familyEntry;
    private int familyId;
    private boolean isFirstLoad = true;
    private int levelsExpRate = 1;
    ...
    private final Map<Integer, Map<MapleBuffStat, MapleBuffStatValueHolder>> buffEffects = new LinkedHashMap<>(); // non-overriding buffs thanks to DrScript
    ...
    public int getTotalMobKilledW() {
        return this.TotalMobKilledW;
    }
    public int getTotalMobKilledM() {
        return this.TotalMobKilledW;
    }
    ...
    public static MapleCharacter loadCharacterEntryFromDB(ResultSet rs, List<Item> equipped) {
        ...
        try {
            ...
            ret.TotalMobKilledW = rs.getInt("TotalMobKilledW");
            ret.TotalMobKilledM = rs.getInt("TotalMobKilledM");

            ret.fishDaily = rs.getInt("fishDaily");
            ret.whenFishMax = rs.getInt("whenFishMax");
            ...
            ret.AegisPoints = rs.getInt("AegisPoints");

            ret.deafultExp = ret.expRate;
            ret.updateExpRateByLevel();
    ...
    public static MapleCharacter loadCharFromDB(int charid, MapleClient client, boolean channelserver) throws SQLException {
        try {
            ...
            ret.whenFishMax = rs.getInt("whenFishMax");
            ret.TotalMobKilledM = rs.getInt("TotalMobKilledM");
            ret.MesoW = rs.getInt("MesoW");
            ret.MesoM = rs.getInt("MesoM");
            ret.NXW = rs.getInt("NXW");
            ret.NXM = rs.getInt("NXM");
            ret.ScrollFailW = rs.getInt("ScrollFailW");
            ret.ScrollFailM = rs.getInt("ScrollFailM");
            ret.FameW = rs.getInt("FameW");
            ret.FameM = rs.getInt("FameM");
            ret.FameGivenW = rs.getInt("FameGivenW");
            ret.FameGivenM = rs.getInt("FameGivenM");
            ret.QuestCW = rs.getInt("QuestCW");
            ret.QuestCM = rs.getInt("QuestCM");
            ret.MiniW = rs.getInt("MiniW");
            ret.MiniM = rs.getInt("MiniM");
            ret.JQW = rs.getInt("JQW");
            ret.JQM = rs.getInt("JQM");
            ret.NGachW = rs.getInt("NGachW");
            ret.NGachM = rs.getInt("NGachM");
            ret.RGachW = rs.getInt("RGachW");
            ret.RGachM = rs.getInt("RGachM");
            ret.OpenMerchW = rs.getInt("OpenMerchW");
            ret.OpenMerchM = rs.getInt("OpenMerchM");
            ret.SellItemW = rs.getInt("SellItemW");
            ret.SellItemM = rs.getInt("SellItemM");
            ret.BoughtItemW = rs.getInt("BoughtItemW");
            ret.BoughtItemM = rs.getInt("BoughtItemM");
            ret.ZakumKillW = rs.getInt("ZakumKillW");
            ret.ZakumKillM = rs.getInt("ZakumKillM");
            ret.ZakumKillT = rs.getInt("ZakumKillT");
            ret.VoteM = rs.getInt("VoteM");
            //Reward Calculator
            ret.WCP = rs.getInt("WCP");
            ret.MCP = rs.getInt("MCP");
            ret.TotalChallengeP = rs.getInt("TotalChallengeP");
            ret.FirstRewardW = rs.getInt("FirstRewardW");
            ret.FirstRewardM = rs.getInt("FirstRewardM");
            ret.SecondRewardW = rs.getInt("SecondRewardW");
            ret.SecondRewardM = rs.getInt("SecondRewardM");
            ret.ThirdRewardW = rs.getInt("ThirdRewardW");
            ret.ThirdRewardM = rs.getInt("ThirdRewardM");
            ret.FourthRewardW = rs.getInt("FourthRewardW");
            ret.FourthRewardM = rs.getInt("FourthRewardM");
            ret.FifthRewardW = rs.getInt("FifthRewardW");
            ret.FifthRewardM = rs.getInt("FifthRewardM");
            //Quests
            ret.QuestsCompleted = rs.getInt("QuestsCompleted");
            //HP NPC
            ret.BossesHp = rs.getInt("BossesHp");
            ret.QuestsHp = rs.getInt("QuestsHp");


            //System.out.println(ret.name + " loading. deafult exprate: " + ret.expRate);
            ret.deafultExp = ret.expRate;
            ret.updateExpRateByLevel();
            //System.out.println("After function: " + ret.expRate);
                ...
                if (mapitem.getItemId() == 4031865 || mapitem.getItemId() == 4031866 || mapitem.getMeso() > 0 || ii.isConsumeOnPickup(mapitem.getItemId()) || (hasSpaceInventory = MapleInventoryManipulator.checkSpace(client, mapitem.getItemId(), mItem.getQuantity(), mItem.getOwner()))) {
                    ...
                    if ((mapId > 209000000 && mapId < 209000016) || (mapId >= 990000500 && mapId <= 990000502)) {//happyville trees and guild PQ
                        if (!mapitem.isPlayerDrop() || mapitem.getDropper().getObjectId() == client.getPlayer().getObjectId()) {
                            if(mapitem.getMeso() > 0) {
                                ...
                                client.announce(MaplePacketCreator.earnTitleMessage("You have earned " + nxGain + " NX"));
                    ...
                    if (mapitem.getMeso() > 0) {
                        if (!mpcs.isEmpty()) {
                            ...
                            this.gainMeso(mapitem.getMeso(), true, true, false);
                            this.addMesoM(mapitem.getMeso());
                            this.addMesoW(mapitem.getMeso());
                        ...
                        // Add NX to account, show effect and make item disappear
                        if (this.gmLevel() >= 2) {
                            int VIPNxGain = mapitem.getItemId() == 4031865 ? 200 : 500;
                            this.getCashShop().gainCash(1, VIPNxGain);
                            this.addNXM(VIPNxGain);
                            this.addNXW(VIPNxGain);

                            client.announce(MaplePacketCreator.earnTitleMessage("[GM]You have earned " + VIPNxGain + " NX."));
                        } else {
                            int nxGain = mapitem.getItemId() == 4031865 ? 100 : 250;
                            this.getCashShop().gainCash(1, nxGain);
                            this.addNXM(nxGain);
    ...
    public void announceDiseases() {
        ...
        chrLock.lock();
        try {
            // Poison damage visibility and diseases status visibility, extended through map transitions thanks to DrScript
    ...
    void deserveItemHandler() {
        int numOfItems = 0;
        if(this.level % 3 == 0)
        {
            numOfItems = rand.nextInt(5 - 3) + 3;
            
            MapleInventoryManipulator.addById(client, 4310005, (short)numOfItems);
            yellowMessage("You Just Won " + String.valueOf(numOfItems) + " Perfect Pich");
        }
    }
    
    public void updateExpRateByLevel() {
        int lastExpRate = this.expRate;
        String message = "none";
        expRate = YamlConfig.config.worlds.get(0).exp_rate;
        ...
        if(level == 10) message = "You have 2 EXP rate now";
        else if(level == 30)  message = "You have 2 EXP rate now";
        else if(level == 70) message = "You have 3 EXP rate now";
        else if(level == 120) message = "You have 3 EXP rate now";
        else if(level == 180) message = "You have 2 EXP rate now";

        if(!isFirstLoad && !message.equals("none"))
        {
            //System.out.println(expRate + " " + lastExpRate);
            this.dropMessage(5, message);
        }
        isFirstLoad = false;
    ...
    public int getWhenFishMax() {
        return this.whenFishMax;
    }

    public Date getWhenFishDate() {
        DateFormat df = new SimpleDateFormat("yyyyMMdd");
        try {
            return (Date)df.parse(String.valueOf(this.whenFishMax));
        } catch(Exception e)
        {
            return new Date();
        }
    ...
    public void setWhenFishMax(int whenFishMax) {
        this.whenFishMax = whenFishMax;
    }


    public int getFishDaily() {
        return this.fishDaily;
    }

    public void setFishDaily(int fishDaily) {
        this.fishDaily = fishDaily;
    }
    ...
    public boolean couldBuyback() {  // DrScript's buyback system
        long timeNow = Server.getInstance().getCurrentTime();
    ...
    public synchronized void levelUp(boolean takeexp) {
        ...
        if (YamlConfig.config.server.USE_PERFECT_PITCH && level >= 30) {
            //milestones?
            if (MapleInventoryManipulator.checkSpace(client, 4310005, (short) 1, "")) {
                MapleInventoryManipulator.addById(client, 4310005, (short) 1, "", -1);
            }
        } else if (level == 10) {
    ...
    public synchronized void saveCharToDB(boolean notAutosave) {
        ...
        try {
            ...
            ps = con.prepareStatement("UPDATE characters SET level = ?, fame = ?, str = ?, dex = ?, luk = ?, `int` = ?, exp = ?, gachaexp = ?, hp = ?, mp = ?, maxhp = ?, maxmp = ?, sp = ?, ap = ?, gm = ?, skincolor = ?, gender = ?, job = ?, hair = ?, face = ?, map = ?, meso = ?, hpMpUsed = ?, spawnpoint = ?, party = ?, buddyCapacity = ?, messengerid = ?, messengerposition = ?, mountlevel = ?, mountexp = ?, mounttiredness= ?, equipslots = ?, useslots = ?, setupslots = ?, etcslots = ?,  monsterbookcover = ?, vanquisherStage = ?, dojoPoints = ?, lastDojoStage = ?, finishedDojoTutorial = ?, vanquisherKills = ?, matchcardwins = ?, matchcardlosses = ?, matchcardties = ?, omokwins = ?, omoklosses = ?, omokties = ?, dataString = ?, fquest = ?, jailexpire = ?, partnerId = ?, marriageItemId = ?, lastExpGainTime = ?, ariantPoints = ?, partySearch = ?, AegisPoints = ?, TotalMobKilledW = ?, TotalMobKilledM = ?, MesoW = ?, MesoM = ?, NXW = ?, NXM = ?, ScrollFailW = ?, ScrollFailM =?, FameW = ?, FameM = ?, FameGivenW = ?, FameGivenM = ?, QuestCW =?, QuestCM =?, WCP = ?, MCP = ?, FirstRewardW = ?, FirstRewardM = ?, SecondRewardW = ?, SecondRewardM = ?, ThirdRewardW = ?, ThirdRewardM = ?, FourthRewardW = ?, FourthRewardM = ?, FifthRewardW = ?, FifthRewardM = ?, MiniW = ?, MiniM = ?, JQW = ?, JQM = ?, QuestsCompleted = ?, BossesHp = ?, QuestsHp = ? , NGachW = ?, NGachM = ?, RGachW = ?, RGachM = ?, OpenMerchW = ?, OpenMerchM = ?, SellItemW = ?, SellItemM = ?, BoughtItemW = ?, BoughtItemM = ?, TotalChallengeP =?, ZakumKillW= ?, ZakumKillM =?, ZakumKillT = ?, VoteM =?, fishDaily = ?, whenFishMax = ? WHERE id = ?", Statement.RETURN_GENERATED_KEYS);
            ...
            ps.setInt(56, AegisPoints);


            ps.setInt(57, TotalMobKilledW);
            ps.setInt(58, TotalMobKilledM);
            ps.setInt(59, MesoW);
            ps.setInt(60, MesoM);
            ps.setInt(61, NXW);
            ps.setInt(62, NXM);
            ps.setInt(63, ScrollFailW);
            ps.setInt(64, ScrollFailM);
            ps.setInt(65, FameW);
            ps.setInt(66, FameM);
            ps.setInt(67, FameGivenW);
            ps.setInt(68, FameGivenM);
            ps.setInt(69, QuestCW);
            ps.setInt(70, QuestCM);
            ps.setInt(71, WCP);
            ps.setInt(72, MCP);
            ps.setInt(73, FirstRewardW);
            ps.setInt(74, FirstRewardM);
            ps.setInt(75, SecondRewardW);
            ps.setInt(76, SecondRewardM);
            ps.setInt(77, ThirdRewardW);
            ps.setInt(78, ThirdRewardM);
            ps.setInt(79, FourthRewardW);
            ps.setInt(80, FourthRewardM);
            ps.setInt(81, FifthRewardW);
            ps.setInt(82, FifthRewardM);
            ps.setInt(83, MiniW);
            ps.setInt(84, MiniM);
            ps.setInt(85, JQW);
            ps.setInt(86, JQM);
            ps.setInt(87, QuestsCompleted);
            ps.setInt(88, BossesHp);
            ps.setInt(89, QuestsHp);
            ps.setInt(90, NGachW);
            ps.setInt(91, NGachM);
            ps.setInt(92, RGachW);
            ps.setInt(93, RGachM);
            ps.setInt(94, OpenMerchW);
            ps.setInt(95, OpenMerchM);
            ps.setInt(96, SellItemW);
            ps.setInt(97, SellItemM);
            ps.setInt(98, BoughtItemW);
            ps.setInt(99, BoughtItemM);
            ps.setInt(100, TotalChallengeP);
            ps.setInt(101, ZakumKillW);
            ps.setInt(102, ZakumKillM);
            ps.setInt(103, ZakumKillT);
            ps.setInt(104, VoteM);
            ps.setInt(105, fishDaily);
            ps.setInt(106, whenFishMax);
    ...
    public void sendPolice(int greason, String reason, int duration) {
        announce(MaplePacketCreator.sendPolice(String.format("You have been blocked by the#b %s Police for %s.#k", "MapleAegis", reason)));
        this.isbanned = true;
    ...
    public void autoban(String reason) {
        ...
        this.ban(reason);
        announce(MaplePacketCreator.sendPolice(String.format("You have been blocked by the#b %s Police for HACK reason.#k", "MapleAegis")));
        TimerManager.getInstance().schedule(new Runnable() {
            @Override
            public void run() {
                client.disconnect(false, false);
    ...
    public int getDonorPoints() {
        ...
        try {
            con = DatabaseConnection.getConnection();
            ps = con.prepareStatement("SELECT donorPoints FROM accounts WHERE id=?;");
            ps.setInt(1, accountid);
    ...
    public void setDonorPoints(int value) {
        Connection con = null;
        PreparedStatement ps = null;
        try {
            con = DatabaseConnection.getConnection();
            ps = con.prepareStatement("UPDATE accounts SET donorPoints=? WHERE id=?;");
            ps.setInt(1, value);
            ps.setInt(2, accountid);
            ps.executeUpdate();
        } catch (SQLException e) {
    ...
    //Finish Speed Run~
    //Weekly
    public void addMobKillW(int gain) {
        if (this.getMobKillW()== -1) {
            return;
        } else {
            this.TotalMobKilledW += gain;
        }
    }

    public int getMobKillW() {
        return this.TotalMobKilledW;
    }

    public void addMesoW(int gain) {
        if (this.getMesoW() == -1) {
            return;
        }else {
            this.MesoW += gain;
    ...
    public void addScrollFailW(int gain) {
        if (this.getScrollFailW()== -1) {
            return;
        } else {
            this.ScrollFailW += gain;
        }
    }
    public int getScrollFailW() {
        return this.ScrollFailW;
    }

    public void addFameW(int gain) {
        if (this.getFameW()== -10) {
            return;
        } else {
            this.FameW += gain;
    ...
    public void AddFameGivenW(int gain) {
        if (this.getFameGivenW()== -1) {
            return;
        } else {
            this.FameGivenW += gain;
        }
    }
    public int getFameGivenW() {
        return this.FameGivenW;
    }

    public void AddQuestCW(int gain) {
        if (this.getQuestCW()== -1) {
            return;
        } else {
            this.QuestCW += gain;
        }
    }
    public int getQuestCW() {
        return this.QuestCW;
    }

    public void addWCP(int gain) {
        this.WCP += gain;
    }
    ...
    public void addNGachW(int gain) {
        if (this.getNGachW()== -1) {
            return;
        } else {
            this.NGachW += gain;
    ...
    public int getNGachW() {
        return this.NGachW;
    }

    public void addRGachW(int gain) {
        if (this.getRGachW()== -1) {
            return;
        } else {
            this.RGachW += gain;
    ...
    public int getRGachW() {
        return this.RGachW;
    }
    public void addMerchOpenW(int gain) {
        if (this.getMerchOpenW()== -1) {
            return;
        } else {
            this.OpenMerchW += gain;
        }
    }
    public int getMerchOpenW() {
        return this.OpenMerchW;
    }

    public void AddSellItemW(int gain) {
        if (this.getSellItemW()== -1) {
            return;
        } else {
            this.SellItemW += gain;
        }
    }
    public int getSellItemW() {
        return this.SellItemW;
    }
    public void AddBoughtItemW(int gain) {
        if (this.getBoughtItemW()== -1) {
            return;
        } else {
            this.BoughtItemW += gain;
        }
    }
    public int getBoughtItemW() {
        return this.BoughtItemW;
    }

    public void addZakumKillW(int gain) {
        if (this.getZakumKillW()== -10) {
            return;
        } else {
            this.ZakumKillW += gain;
        }
    }
    public int getZakumKillW() {
        return this.ZakumKillW;
    }

    public void addZakumKillT(int gain) {
        if (this.getZakumKillT()== -10) {
            return;
        } else {
            this.ZakumKillT += gain;
        }
        //this.updateQuestAttackRing();
    }
    public int getZakumKillT() {
        return this.ZakumKillT;
    }


    //Monthly

    public void addMobKillM(int gain) {
        if (this.getMobKillM() == -1) {
            return;
        }else {
            this.TotalMobKilledM += gain;
        }
    }
    public int getMobKillM() {
        return this.TotalMobKilledM;
    }

    public void addZakumKillM(int gain) {
        if (this.getZakumKillM()== -10) {
            return;
        } else {
            this.ZakumKillM += gain;
        }
    }
    public int getZakumKillM() {
        return this.ZakumKillM;
    }



    public void addNXM(int gain) {
        if (this.getNXM()== -1) {
            return;
        } else {
            this.NXM += gain;
    ...
    public void addScrollFailM(int gain) {
        if (this.getScrollFailM() == -1) {
            return;
        }else {
            this.ScrollFailM += gain;
        }
    }

    public int getScrollFailM() {
        return this.ScrollFailM;
    }

    public void addFameM(int gain) {
        if (this.getFameM() == -10) {
            return;
        }else {
            this.FameM += gain;
    ...
    public void AddFameGivenM(int gain) {
        if (this.getFameGivenM() == -1) {
            return;
        }else {
            this.FameGivenM += gain;
        }
    }
    public int getFameGivenM() {
        return this.FameGivenM;
    }

    public void AddQuestCM(int gain) {
        if (this.getQuestCM() == -1) {
            return;
        }else {
            this.QuestCM += gain;
        }
    ...
    public int getQuestCM() {
        return this.QuestCM;
    }

    public void addMiniW(int gain) {
        if (this.getMiniW() == -1) {
            return;
        }else {
            this.MiniW += gain;
    ...
    public void addTotalChallengeP(int gain) {
        this.TotalChallengeP += gain;
    }

    public int getTotalChallengeP() {
        return this.TotalChallengeP;
    }
    ...
    public void addQuestsCompleted(int gain) {
        this.QuestsCompleted += gain;
    }

    public void addNGachM(int gain) {
        if (this.getNGachW()== -1) {
            return;
        } else {
            this.NGachM += gain;
    ...
    public int getNGachM() {
        return this.NGachM;
    }

    public void addRGachM(int gain) {
        if (this.getRGachM()== -1) {
            return;
        } else {
            this.RGachM += gain;
    ...
    public int getRGachM() {
        return this.RGachM;
    }

    public void addMerchOpenM(int gain) {
        if (this.getMerchOpenM()== -1) {
            return;
        } else {
            this.OpenMerchM += gain;
        }
    }
    public int getMerchOpenM() {
        return this.OpenMerchM;
    }

    public void addSellItemM(int gain) {
        if (this.getSellItemM()== -1) {
            return;
        } else {
            this.SellItemM += gain;
        }
    }
    public int getSellItemM() {
        return this.SellItemM;
    }
    public void AddBoughtItemM(int gain) {
        if (this.getBoughtItemM()== -1) {
            return;
        } else {
            this.BoughtItemM += gain;
        }
    }
    public int getBoughtItemM() {
        return this.BoughtItemM;
    }
    //When Completed//

    public void setMesoW(int meso) {
        this.MesoW = meso;
    }
    public void setMesoM(int meso) {
        this.MesoM = meso;
    }
    public void setMobKilledW(int kill) {
        this.TotalMobKilledW = kill;
    }
    public void setMobKilledM(int kill) {
        this.TotalMobKilledM = kill;
    }

    public void setNXW(int NX) {
        this.NXW = NX;
    }
    public void setNXM(int NX) {
        this.NXM = NX;
    }
    public void setScrollFailsW(int fails) {
        this.ScrollFailW = fails;
    }
    public void setScrollFailsM(int fails) {
        this.ScrollFailM = fails;
    }
    public void setFameW(int fame) {
        this.FameW = fame;
    }
    public void setFameM(int fame) {
        this.FameM = fame;
    }
    public void setFameGivenW(int fame) {
        this.FameGivenW = fame;
    }
    public void setFameGivenM(int fame) {
        this.FameGivenM = fame;
    }
    public void setQuestW(int q) {
        this.QuestCW = q;
    }
    public void setQuestM(int q) {
        this.QuestCM = q;
    }
    public void setMiniW(int win) {
        this.MiniW = win;
    }
    public void setMiniM(int win) {
        this.MiniM = win;
    }
    public void setJQW(int win) {
        this.JQW = win;
    }
    public void setJQM(int win) {
        this.JQM = win;
    }
    public void setNGachW(int nr) {
        this.NGachW = nr;
    }
    public void setRGachW(int nr) {
        this.RGachW = nr;
    }
    public void setNGachM(int nr) {
        this.NGachM = nr;
    }
    public void setRGachM(int nr) {
        this.RGachM = nr;
    }
    public void setSellItemW(int nr) {
        this.SellItemW = nr;
    }
    public void setSellItemM(int nr) {
        this.SellItemM = nr;
    }
    public void setOpenMerchW(int nr) {
        this.OpenMerchW = nr;
    }
    public void setOpenMerchM(int nr) {
        this.OpenMerchM = nr;
    }
    public void setBoughtItemW(int nr) {
        this.BoughtItemW = nr;
    }
    public void setBoughtItemM(int nr) {
        this.BoughtItemM = nr;
    }
    public void setZakumKillW(int nr) {
        this.ZakumKillW = nr;
    }
    public void setZakumKillM(int nr) {
        this.ZakumKillM = nr;
    }
    ...
    //Weekly Rewards //
    public void AddFirstRewardW(int gain) {
        this.FirstRewardW += gain;
    }

    public int getFirstRewardW() {
        return this.FirstRewardW;
    }
    public void AddSecondRewardW(int gain) {
        this.SecondRewardW += gain;
    }
    public int getSecondRewardW() {
        return this.SecondRewardW;
    }
    public void AddThirdRewardW(int gain) {
        this.ThirdRewardW += gain;
    }
    public int getThirdRewardW() {
        return this.ThirdRewardW;
    }
    public void addFourthRewardW(int gain) {
        this.FourthRewardW += gain;
    }

    public int getFourthRewardW() {
        return this.FourthRewardW;
    }

    public void addFifthRewardW(int gain) {
        this.FifthRewardW += gain;
    }

    public int getFifthRewardW(){
        return this.FifthRewardW;
    }


    //Monthly Rewards//
    public void AddFirstRewardM(int gain) {
        this.FirstRewardM += gain;
    }

    public int getFirstRewardM() {
        return this.FirstRewardM;
    }
    public void AddSecondRewardM(int gain) {
        this.SecondRewardM += gain;
    }
    public int getSecondRewardM() {
        return this.SecondRewardM;
    }
    public void AddThirdRewardM(int gain) {
        this.ThirdRewardM += gain;
    }
    public int getThirdRewardM() {
        return this.ThirdRewardM;
    }
    public void addFourthRewardM(int gain) {
        this.FourthRewardM += gain;
    }

    public int getFourthRewardM() {
        return this.FourthRewardM;
    }

    public void addFifthRewardM(int gain) {
        this.FifthRewardM += gain;
    }

    public int getFifthRewardM(){
        return this.FifthRewardM;
    }




    public int getAegisPoints() {
        return this.AegisPoints;
    }
    
    public void giveAegisPoints(int num) {
        this.AegisPoints += num;
    }
    
    public void setTotalAegisPoints(int num) {
        this.AegisPoints = num;
    }
    ...
    public int getBossesHp(){
        return BossesHp;
    }

    public int getQuestsHp(){
        return QuestsHp;
    }

    public void addBossesHp(int x){
        this.BossesHp += x;
    }

    public void addQuestsHp(int x){
        this.QuestsHp += x;
    }
