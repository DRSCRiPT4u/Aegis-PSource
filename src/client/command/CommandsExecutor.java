...
public class CommandsExecutor {
    ...
    private void registerLv0Commands() {
        ...
        //addCommand("itemlevel", ItemLevelCommand.class);
        addCommand("droplimit", DropLimitCommand.class);
        addCommand("mmf", MMFCommand.class);

        addCommand("pitch", PitchCommand.class);
        //addCommand("challenge", ChallengeCommand.class);

        addCommand("wc", ChallengeCommand.class);
        addCommand("mc", MonthlyChallenge.class);
        addCommand("cp", ShowCProgress.class);

        //addCommand("getdonorpoints", GetDonorPoints.class);
    ...
    private void registerLv3Commands() {
        ...
        addCommand("online", 3, OnlineTwoCommand.class);
        ...
        addCommand("levelup", 3, LevelUpCommand.class);
    ...
    private void registerLv4Commands() {
        ...
        addCommand("givedonorpoints", GiveDonorPointsCommand.class);
    ...
    private void registerLv6Commands() {
        ...
        addCommand("getexprate", 6, GetExpRateCommand.class);
