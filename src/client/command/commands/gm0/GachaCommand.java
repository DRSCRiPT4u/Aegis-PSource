...
public class GachaCommand extends Command {
    ...
    public void execute(MapleClient c, String[] params) {
        ...
        String gachaName = "";
        String[] names = {"Henesys", "Ellinia", "Perion", "Kerning City", "Sleepywood", "Mushroom Shrine", "Showa Spa Male", "Showa Spa Female", "New Leaf City", "Nautilus Harbor", "Winter City"};
        int[] ids = {9100100, 9100101, 9100102, 9100103, 9100104, 9100105, 9100106, 9100107, 9100109, 9100117, 9999800};
