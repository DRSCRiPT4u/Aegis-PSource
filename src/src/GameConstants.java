...
public class GameConstants {
    ...
    // DrScript's rates upgrade system
    ...
    public static final HashMap<String, Integer> GOTO_AREAS = new HashMap<String, Integer>() {{
        ...
        put("pbhouse", 910020030);
        put("aquaris", 992045000);
        put("keep", 610020006);
        put("dojo", 925020001);
        put("bosspq", 970030000);
        put("fm", 910000000);
        put("fmquest", 970000100);
        put("fmpq", 970000200);
    }};
    ...
    public static boolean isFreeMarketRoom(int mapid) {
        return mapid / 1000000 == 910 && mapid > 910000000; // FM rooms subset
    }
    ...
    public static boolean isFishingArea(int mapid) {
        ...
        return mapid == 910020020; // Fishing Map ID
    }
