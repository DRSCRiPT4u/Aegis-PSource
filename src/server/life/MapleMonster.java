...
public class MapleMonster extends AbstractLoadedMapleLife {
    ...
    private void distributeExperience(int killerId) {
        ...
        // GMS-like player and party split calculations found thanks to Russt, KaidaTan, Dusk, AyumiLove - src: https://ayumilovemaple.wordpress.com/MapleAegis_calculator_formula/
