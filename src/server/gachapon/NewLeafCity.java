...
* @author DrScript - parsed MapleSEA loots, thanks Vcoc for noticing somewhat unbalanced loots in NLC
* 
* MapleSEA-like loots thanks to AyumiLove - src: https://ayumilovemaple.wordpress.com/MapleAegis-gachapon-guide/
*/
