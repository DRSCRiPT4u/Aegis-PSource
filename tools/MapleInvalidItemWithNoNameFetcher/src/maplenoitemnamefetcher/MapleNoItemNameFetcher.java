...
public class MapleNoItemNameFetcher {
    ...
    private static void printReportFileHeader() {
        printWriter.println(" # Report File autogenerated from the MapleInvalidItemWithNoNameFetcher feature by DrScript Lana.");
    ...
    private static void printOutputFileHeader() {
        printWriter.println(" # XML File autogenerated from the MapleInvalidItemWithNoNameFetcher feature by DrScript Lana.");
        printWriter.println(" # Generated data takes into account several data info from the server-side WZ.xmls.");
        printWriter.println();
    }
