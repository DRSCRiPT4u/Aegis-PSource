...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (sel == 0)
            ...
            cm.sendNext("It's the currency used in MapleAegis. You may purchase items through mesos. To earn them, you may either defeat the monsters, sell items at the store, or complete quests...");
    } else if (status == 1) {
        if (sel == 0)
